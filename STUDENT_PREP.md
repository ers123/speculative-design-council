...
설치 가이드 (한·영, Mac+Windows): **[INSTALL.md](INSTALL.md)**
...
- [ ] 폰에서 Edge Gallery 열고 Gemma 4 E2B로 *"안녕"* 한 줄 응답 받음
...
Installation guide (bilingual, Mac+Win): **[INSTALL.md](INSTALL.md)**
...
- [ ] Phone: Edge Gallery responds to *"hello"* with Gemma 4 E2B
- [ ] Cloud AI logged in
